...
export const cartController = {
  ...
  update: asyncHandler(async (req, res) => sendSuccess(res, await cartService.updateItem(req.user!.id, requireParam(req.params, 'productId'), req.body.quantity), 'Cart updated')),
